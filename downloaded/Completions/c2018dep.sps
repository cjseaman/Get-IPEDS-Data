...
cipcode  'CIPCODE' 
ptotal   'Number of programs offered' 
ptotalde 'Number of programs offered via distance education' 
passoc   'Number of Associate^s degree programs offered' 
passocde 'Number of Associate^s degree programs offered via distance education' 
pbachl   'Number of Bachelor^s degree programs offered' 
pbachlde 'Number of Bachelor^s degree programs offered via distance education' 
pmastr   'Number of Master^s degree programs offered' 
pmastrde 'Number of Master^s degree programs offered via distance education' 
pdocrs   'Number of Doctor^s degree-research/scholarship programs offered' 
pdocrsde 'Number of Doctor^s degree-research/scholarship programs offered via distance education' 
pdocpp   'Number of Doctor^s degree-professional practice programs offered' 
pdocppde 'Number of Doctor^s degree-professional practice programs offered via distance education' 
pdocot   'Number of Doctor^s degree-other programs offered' 
pdocotde 'Number of Doctor^s degree-other programs offered via distance education' 
pcert1   'Number of less than 1-year certificate programs offered' 
pcert1de 'Number of less than 1-year certificate programs offered via distance education' 
pcert2   'Number of 1-year, but less than-2-year certificate programs offered' 
pcert2de 'Number of 1-year, but less than 2-year certificate programs offered via distance education' 
pcert4   'Number of 2-year, but less than 4-year certificate programs offered' 
pcert4de 'Number of 2-year, but less than 4-year certificate programs offered via distance education' 
ppbacc   'Number of Postbaccalaureate certificate programs offered' 
ppbaccde 'Number of Postbaccalaureate certificate programs offered via distance education' 
ppmast   'Number of Post-master^s certificate programs offered' 
ppmastde 'Number of Post-master^s certificate programs offered via distance education'.
...
ptotal   ptotalde passoc   passocde pbachl   pbachlde pmastr   pmastrde
pdocrs   pdocrsde pdocpp   pdocppde pdocot   pdocotde pcert1   pcert1de pcert2   pcert2de
pcert4   pcert4de ppbacc   ppbaccde ppmast   ppmastde
/stats=def.

save outfile='c2018dep_dist.sav' /compressed.
